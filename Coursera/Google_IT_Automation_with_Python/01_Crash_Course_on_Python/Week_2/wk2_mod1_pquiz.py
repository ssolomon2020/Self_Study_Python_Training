...
# 01. In this scenario, two friends are eating dinner at a restaurant. The bill comes in the amount of 47.28 dollars. 
...
# 02. This code is supposed to take two numbers, divide one by another so that the result is equal to 1, and display the result on the screen. 
...
# 03. Combine the variables to display the sentence "How do you like Python so far?" 
...
# 04. This code is supposed to display "2 + 2 = 4" on the screen, but there is an error.
